...
FFMPEG_SRC_LIBAVCODEC=\
        $(FFMPEG_LIBAVCODEC_TOP)/ac3.c \
        $(FFMPEG_LIBAVCODEC_TOP)/ac3_parser.c \
        $(FFMPEG_LIBAVCODEC_TOP)/ac3dec.c \
        $(FFMPEG_LIBAVCODEC_TOP)/ac3dec_data.c \
        $(FFMPEG_LIBAVCODEC_TOP)/ac3dsp.c \
        $(FFMPEG_LIBAVCODEC_TOP)/ac3tab.c \
