...
void av_register_all(void)
{
    ...
    /*
     Anapass Support  :
        ...
        Demuxer : WMV, asf,  3gp, avi  mov,flv,               k3g, MKV,  skm, ts/tp  webm,  vob
        Video   : Mpeg4 SP/ASP ,  H263,  H264 BP/MP/HP , MSMpeg4, Divx 3/4/5/6, XVid, Mpeg 1/2  VP8   Theora,  MJPEG,  VC-1/WMV9   RV 8/9/10
