...
struct RMStream {
    ...
    int64_t audiotimestamp_before; ///< Audio packet timestamp
    int packet_count_max;
#endif
};
                      ...
                      AVStream *st, RMStream *ast, AVPacket *pkt)
{
    ...
    if ((pkt->pts = ast->audiotimestamp) != AV_NOPTS_VALUE) {
        ...
        ast->audiotimestamp_before = ast->audiotimestamp;
        ast->packet_count_max = rm->audio_pkt_cnt+1;
        ...
        pkt->pts = ast->audiotimestamp_before + ast->packet_count_max - rm->audio_pkt_cnt;
        pkt->flags = 0;
    }
