...
/*
     Anapass Support  :
        ...
        Demuxer : 3gp, avi flv, k3g, MKV, mov, skm, ts/tp  webm, WMV, asf, vob
        Video   : Mpeg4 SP/ASP ,  H263, VC-1/WMV9      H264 BP/MP/HP , MSMpeg4, Divx 3/4/5/6, XVid, Mpeg 1/2  VP8   Theora,  MJPEG,     RV 8/9/10
        Audio   : AAC(HE-AAC1, HE-AAC2,  AMR-WB/NB , EVRC, QCELP, PCM/LPCM/ADPCM,  MP2, MP3, AC3, Vorbis, FLAC, RA, u-law,  GSM, WMA

     Anapass Non-Support :
 
        Demuxer  : 4gp/5gp/6gp  divx  f4v
        Video    : VP 6/7  ,  WMV 7/8 10,  
        Audio    :  EVRC,  Rich Music Format, DTS,  XMF 
    */
