...
extern "C"{
	...
	int getJpgEncOpenParamDefault(JpgEncOpenParam *pEncOP, JPU_EncConfigParam *pEncConfig, int TmbEn);
	int getJpgEncOpenParam(JpgEncOpenParam *pEncOP, JPU_EncConfigParam *pEncConfig, char *srcYuvFileName);
	int parseJpgCfgFile(JPU_ENC_CFG *pEncCfg, char *FileName);
 
	
	JpgRet WriteJpgBsBufHelper(JpgDecHandle handle,
		JPU_BufInfo *pBufInfo,
	...
	int JPU_WriteBsBufFromBufHelper(JpgDecHandle handle, 
