...
public:
    ...
    MMP_VIR_ADDR get_buf_vir_addr(MMP_S32 frame_id = 0);
    ...
    inline MMP_VIR_ADDR get_buf_vir_addr_y() { return this->get_buf_vir_addr(MMP_YUV420_PLAINE_INDEX_Y); }
    inline MMP_VIR_ADDR get_buf_vir_addr_cb() { return this->get_buf_vir_addr(MMP_YUV420_PLAINE_INDEX_U); }
    inline MMP_VIR_ADDR get_buf_vir_addr_cr() { return this->get_buf_vir_addr(MMP_YUV420_PLAINE_INDEX_V); }
