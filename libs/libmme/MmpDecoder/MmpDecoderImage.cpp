...
CMmpDecoderImage::CMmpDecoderImage(struct MmpDecoderCreateConfig *pCreateConfig, MMP_BOOL bNeedDecodedBufPhyAddr) : CMmpDecoder(pCreateConfig->nFormat, pCreateConfig->nStreamType) 
...
void CMmpDecoderImage::DecodeMonitor(CMmpMediaSample* pMediaSample, CMmpMediaSampleDecodeResult* pDecResult) {
