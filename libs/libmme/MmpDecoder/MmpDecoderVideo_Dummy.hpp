...
#ifndef MMPDECODERVIDEO_DUMMY_HPP__
#define MMPDECODERVIDEO_DUMMY_HPP__

#include "MmpDecoderVideo.hpp"
#include "MmpDecoderFfmpeg.hpp"

class CMmpDecoderVideo_Dummy : public CMmpDecoderVideo, CMmpDecoderFfmpeg
{
...
protected:
    CMmpDecoderVideo_Dummy(struct MmpDecoderCreateConfig *pCreateConfig);
    virtual ~CMmpDecoderVideo_Dummy();
