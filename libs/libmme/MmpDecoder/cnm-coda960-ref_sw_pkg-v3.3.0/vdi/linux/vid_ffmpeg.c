...
static struct ffmpeg_obj s_ffmpeg_obj;
...
static MMP_RESULT do_BIT_RUN_COMMAND_SEQ_INIT(unsigned long base_reg_addr) {
...
static MMP_RESULT do_BIT_RUN_COMMAND_PIC_RUN(unsigned long base_reg_addr) {
...
static void do_BIT_RUN_COMMAND(unsigned long base_reg_addr, unsigned int data) {
    ...
    switch(data) {
        ...
        case SEQ_INIT: do_BIT_RUN_COMMAND_SEQ_INIT(base_reg_addr); break;
        case PIC_RUN: do_BIT_RUN_COMMAND_PIC_RUN(base_reg_addr); break;
    }
}
