...
typedef struct {
    ...
    int IDRPeriod;  /30                             /* [IN] GOP number(interval of I-frame) */

    int SliceMode;    0                          /* [IN] Multi slice mode */
    int RandomIntraMBRefresh;  0                 /* [IN] cyclic intra refresh */
    int EnableFRMRateControl; 1                  /* [IN] frame based rate control enable */
    int Bitrate;               3200kbps                 /* [IN] rate control parameter(bit rate) */
    int FrameQp; 20(default)                               /* [IN] The quantization parameter of the frame */
    int FrameQp_P; 20(default)                             /* [IN] The quantization parameter of the P frame */
    int QSCodeMax; default                             /* [IN] Maximum Quantization value */
    int QSCodeMin; default                             /* [IN] Minimum Quantization value */
    int CBRPeriodRf;  default                          /* [IN] Reaction coefficient parameter for rate control */
    int PadControlOn; 0                          /* [IN] Enable padding control */
    int LumaPadVal;   0                          /* [IN] Luma pel value used to fill padding area */
    int CbPadVal;     0                          /* [IN] CB pel value used to fill padding area */
    int CrPadVal;     0                          /* [IN] CR pel value used to fill padding area */
    int FrameMap;                               /* [IN] Encoding input mode(tile mode or linear mode) */
    SSBSIP_MFC_OUTSTRM_MODE_TYPE OutputMode;    /* [IN] Output mode: Frame/Slice */

    /* H.264 specific parameters */
    int ProfileIDC;   bp                  /* [IN] profile */
    int LevelIDC;     3.0                   /* [IN] level */
    int FrameQp_B;    default                  /* [IN] The quantization parameter of the B frame */
    int FrameRate;    30                  /* [IN] rate control parameter(frame rate) */
    int SliceArgument;  default                /* [IN] MB number or byte number */
    int NumberBFrames;  0                /* [IN] The number of consecutive B frame inserted */
    int NumberReferenceFrames;  1(default)(        /* [IN] The number of reference pictures used */
    int NumberRefForPframes;    1(default)(        /* [IN] The number of reference pictures used for encoding P pictures */
    
    int LoopFilterDisable;  Enable(0)             /* [IN] disable the loop filter */
    int LoopFilterAlphaC0Offset;  0      /* [IN] Alpha & C0 offset for H.264 loop filter */
    int LoopFilterBetaOffset;     0      /* [IN] Beta offset for H.264 loop filter */
    int SymbolMode;            cavlc         /* [IN] The mode of entropy coding(CABAC, CAVLC) */
    int PictureInterlace;   diaable            /* [IN] Enables the interlace mode */
    int Transform8x8Mode;       0        /* [IN] Allow 8x8 transform(This is allowed only for high profile) */
    int EnableMBRateControl;    1        /* [IN] Enable macroblock-level rate control */
    
    int DarkDisable;          1          /* [IN] Disable adaptive rate control on dark region */
    int SmoothDisable;        1          /* [IN] Disable adaptive rate control on smooth region */
    int StaticDisable;        1          /* [IN] Disable adaptive rate control on static region */
    int ActivityDisable;      1          /* [IN] Disable adaptive rate control on high activity region */
