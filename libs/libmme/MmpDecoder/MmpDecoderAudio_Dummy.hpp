...
#ifndef _MMPDECODERAUDIO_DUMMY_HPP__
#define _MMPDECODERAUDIO_DUMMY_HPP__

#include "MmpDecoderAudio.hpp"
#include "MmpDecoderFfmpeg.hpp"


class CMmpDecoderAudio_Dummy : public CMmpDecoderAudio, CMmpDecoderFfmpeg
{
...
protected:
    CMmpDecoderAudio_Dummy(struct MmpDecoderCreateConfig *pCreateConfig);
    virtual ~CMmpDecoderAudio_Dummy();
    ...
    void AudioConvert_Processing(MMP_U32 uiTimeStamp, AVFrame *pAVFrame_Decoded, AVCodecContext *pAVCodecContext);
