...
#ifndef MMP_VPU_DEV_EX2_HPP__
#define MMP_VPU_DEV_EX2_HPP__
...
class mmp_vpu_dev_ex2 : public mmp_vpu_dev {
...
protected:
	...
	mmp_vpu_dev_ex2(struct mmp_vpu_dev_create_config* p_create_config);
	virtual ~mmp_vpu_dev_ex2();
