...
#ifndef MMP_VPU_SAMPLE_HPP__
#define MMP_VPU_SAMPLE_HPP__

#include "mmp_vpu.hpp"

class mmp_vpu_sample : public mmp_vpu {

friend class mmp_vpu;

private:
		
protected:
    
	mmp_vpu_sample(struct mmp_vpu_create_config* p_create_config);
	virtual ~mmp_vpu_sample();
