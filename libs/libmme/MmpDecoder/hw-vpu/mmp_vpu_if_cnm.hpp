...
#ifndef MMP_VPU_IF_CNM_HPP__
#define MMP_VPU_IF_CNM_HPP__

#include "mmp_vpu_if.hpp"

class mmp_vpu_if_cnm : public mmp_vpu_if {
...
protected:
	...
	mmp_vpu_if_cnm(struct mmp_vpu_if_create_config* p_create_config);
	virtual ~mmp_vpu_if_cnm();
