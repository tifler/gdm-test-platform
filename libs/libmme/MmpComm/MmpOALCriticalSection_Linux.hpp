...
#ifndef	__MMPOALCRITICALSECTION_LINUX_HPP
#define	__MMPOALCRITICALSECTION_LINUX_HPP
...
class CMmpOALCriticalSection_Linux : public CMmpOALCriticalSection
{
private:
	
public:   
   CMmpOALCriticalSection_Linux();
   virtual ~CMmpOALCriticalSection_Linux();
