...
#ifndef MMPPLAYERAVEX2_HPP__
#define MMPPLAYERAVEX2_HPP__
...
class CMmpPlayerAVEx2 : public CMmpPlayer
{
...
protected:
    CMmpPlayerAVEx2(CMmpPlayerCreateProp* pPlayerProp);
    virtual ~CMmpPlayerAVEx2();
