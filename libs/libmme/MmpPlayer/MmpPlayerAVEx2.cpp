...
/////////////////////////////////////////////////////////////
//CMmpPlayerAVEx2 Member Functions

CMmpPlayerAVEx2::CMmpPlayerAVEx2(CMmpPlayerCreateProp* pPlayerProp) : CMmpPlayer(pPlayerProp)
,m_pDemuxer(NULL)
...
CMmpPlayerAVEx2::~CMmpPlayerAVEx2()
{
    
    
}

MMP_RESULT CMmpPlayerAVEx2::Open()
{
    ...
    if(mmpResult == MMP_SUCCESS ) {
        m_pDecoderVideo = (CMmpDecoderVideo*)this->CreateDecoderVideo(m_pDemuxer, MMP_FALSE /* bFFmpeg Use*/);
...
MMP_RESULT CMmpPlayerAVEx2::Close()
{
...
MMP_RESULT CMmpPlayerAVEx2::Seek(MMP_S64 pts) {
    ...
    MMPDEBUGMSG(1, (TEXT("[CMmpPlayerAVEx2::Seek] pts=%d "), (unsigned int)(pts/1000) ));
...
void CMmpPlayerAVEx2::Service_AudioDec() {
...
void CMmpPlayerAVEx2::Service_AudioRender() {
...
void CMmpPlayerAVEx2::Service_VideoDec() {
...
void CMmpPlayerAVEx2::Service_VideoRender() {
