...
extern struct SENSOR VIGEN_Sensor;

/*********************************************************************************/
/* sensor  OV8820 register mapping                                               */
/*********************************************************************************/

// Select Input Type and size 
//    ex) In case using OV2715_640x480_8fps, open OV2715 and OV2715_640x480_8fps
#define INPUTMODE_OV2715						0x10
#define INPUTMODE_OV2715_640x480_8FPS			0x11	
#define INPUTMODE_OV2715_1920x1080_10FPS		0x12
#define INPUTMODE_OV2715_640x480_6FPS           0x13

#define INPUTMODE_VIGEN							0xF0
#define INPUTMODE_VIGEN_640x480					0xF1
#define INPUTMODE_VIGEN_1920x1080				0xF2
#define INPUTMODE_VIGEN_4208x3120				0xF3

#define INPUTMODE_V_SENSOR						0x00
