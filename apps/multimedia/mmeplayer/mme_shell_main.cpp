...
struct mme_command mme_cmds[] = { 
        ...
        { (char*)"ff"      ,mme_command_player_tool,  (char*)"player fast forward"},
        { (char*)"rew"     ,mme_command_player_tool,  (char*)"player rewind      "},
        { (char*)"rand"    ,mme_command_player_tool,  (char*)"player random access "},
        { (char*)"pb"      ,mme_command_player_tool,  (char*)"player play-back "},
